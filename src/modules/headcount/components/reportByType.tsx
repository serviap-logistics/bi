...
import HeadcountTableByDate from '../byDate/tableByDate';
import HeadcountTableByRole from '../byRole/tableByRole';
import HeadcountSummary from './summary';
import { ArrowDownCircleIcon } from '@heroicons/react/24/outline';
import { saveAs } from 'file-saver';
import { ProjectContext } from '.';
import TabsMenu, {
  tabs_menu_option_type,
} from '../../../utils/components/tabsMenu';
...
export default function HeadcountReportByType() {
  ...
  const [reportTypes, setReportTypes] = useState<pill_menu_option_type[]>([
