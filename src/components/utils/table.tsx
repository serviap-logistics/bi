  ...
  return (
    <div className={classNames(
      ...
      <div className="mt-4 flow-root">
        <div className={`${! styles?.full_width ? '-mx-4 sm:-mx-6 lg:-mx-8':''} -my-2 overflow-x-auto overscroll-none`}>
          <div className={`inline-block min-w-full py-2 align-middle ${! styles?.full_width ? 'px-2 sm:px-4': ''} ${styles?.max_height} overflow-y-scroll`}>
