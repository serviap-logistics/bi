...
export async function getPurchases (settings: airtable_request_type) : Promise<purchase_type[]> {
  return await airtableRequest(`${AIRTABLE_HOST}/${USA_PURCHASES_BASE}/${USA_PURCHASES_TABLE}`, settings)
}
