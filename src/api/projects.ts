...
export async function getProjects(settings: airtable_request_type): Promise<project_type[]> {
  return await airtableRequest(`${AIRTABLE_HOST}/${USA_OPERATIONS_BASE}/${USA_PROJECTS_TABLE}`, settings)
}